...
export const environmentColumns = ["id","organization_id","type"] as const satisfies (keyof Environment)[];

export const instanceColumns = ["auto_advance","control_signal","created_by","created_on","current_node_id","current_variables","deployment_id","ended_on","id","input_variables","is_deleted","output_variables","status"] as const satisfies (keyof Instance)[];
...
export const secretProviderColumns = ["configuration","created_on","id","label","modified_on","organization_id","type"] as const satisfies (keyof SecretProvider)[];

export const secretReferenceColumns = ["created_on","environment_id","id","provider_id","secret_key"] as const satisfies (keyof SecretReference)[];
